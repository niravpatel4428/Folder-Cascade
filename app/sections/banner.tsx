...
const Banner = () => {
    ...
    return (
        <>
            <section id='home' className="bg-cs-gray50 relative pt-27 pb-10 md:pb-20 xl:pb-30 3xl:pb-37.5">
                    ...
                    <div className="pt-13.5 space-y-13.5 text-center w-full max-w-250 mx-auto">
                        <div>
                            <div className="space-y-4">
                                ...
                                <div className="space-y-2 text-black text-22 font-medium tracking-tighter leading-normal capitalize">
                            ...
                            <div className="mt-7.5 flex justify-center">
                                <div className="flex flex-col items-center gap-1">
                                    {/* Platform Note */}
                                    <span className="text-sm lg:text-base font-normal leading-normal text-center">
                                        Requires macOS
                                    </span>
                                    ...
                                    {isMac ? (
                                        ...
                                        <BtnAppStore label="Send link to my Mac" icon={icon} onClick={() => setEmailModalOpen(true)} />
                                    )}</div>
                            </div>
                        </div>
